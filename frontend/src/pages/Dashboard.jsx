 ...
 useEffect(() => {
  ...
  return (
    <div className={`min-h-screen flex`}>
      ...
      {/* SIDEBAR */}
      <div
        className={`fixed md:relative z-50 w-72 min-h-screen bg-[#0b0f19] text-white p-5
      ...
      >
        ...
        <button
          onClick={logout}
          className="mt-52 w-full bg-red-500/10 text-red-400 py-3 rounded-xl font-bold"
        >
      ...
      {/* MAIN AREA */}
      <div className="flex-1 p-6 md:p-10 bg-gradient-to-br from-blue-50 to-cyan-50">
        {/* TOP BAR */}
        ...
        <p className="text-md font-medium text-blue-600 text-center mt-3">
